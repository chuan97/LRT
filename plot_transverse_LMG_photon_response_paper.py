...
cm = ax.pcolormesh(
    lam0s, ws, -Dm.T.imag, cmap="BuPu", norm=mpl.colors.LogNorm(vmin=vmin, vmax=vmax), shading='auto'
)
...
fig.savefig(
    "plots/transverse_LMG_photon_response_paper.jpeg", bbox_inches="tight", dpi=300
)
