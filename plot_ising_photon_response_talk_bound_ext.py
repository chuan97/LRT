...
#         transform=ax.transAxes
#         )
ax.plot(lam0s, wupperbound, c="k", ls=(0, (1, 10)), lw=2)
ax.plot(lam0s, wlowerbound, c="k", ls=(0, (1, 10)), lw=2)
...
fig.savefig(
    "plots/ising_photon_response_talk_bound_ext.jpeg", bbox_inches="tight", dpi=300
)
